      ...
      <div className="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-blue-50">
        <div className="flex md:contents">
          <div className=" col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
            <h3 className="font-semibold text-lg mb-3">Awura Computing PLC</h3>
            <div className="flex">
              <svg
              ...
              <p className="text-gray-500 leading-tight text-justify">
                I am building responsive layouts using React.js and Material UI.
              </p>
            </div>
            <div className="flex">
              <svg
              ...
              <p className="text-gray-500 leading-tight text-justify">
                Implement React best practices to build truly reusable
                components.
              </p>
            </div>
          </div>
        ...
        <div className="flex md:contents">
          ...
          <div className=" col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
            <h3 className="font-semibold text-lg mb-3">Bitapps Technology</h3>
            <div className="flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 mr-2"
        ...
        <div className="flex flex-row-reverse md:contents">
          <div className=" col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
            <h3 className="font-semibold text-lg mb-3">Tech1 Factory</h3>
            <div className="flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 mr-2"
